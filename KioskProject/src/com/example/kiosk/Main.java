...
public class Main {
    public static void main(String[] args) {
        ...
        Cart cart = new Cart();
        Kiosk kiosk = new Kiosk(menuList, sc, cart);
        ...
        //생성자 호출
        tarot.add(new MenuItem("오늘의 운세", "3,000", "카드 한장으로 오늘의 운세를 점쳐드립니다."));
        ...
        naming.add(new MenuItem("작명", "15,000", "외국인의 한국 이름을 지어드립니다."));

        //메뉴 선택
        kiosk.start(tarot, fate, naming);
    }
}
